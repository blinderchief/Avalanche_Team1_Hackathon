...
export default defineConfig(({ mode }) => ({
  ...
  resolve: {
      alias: [
        ...
        { find: "eventemitter3", replacement: path.resolve(__dirname, "./src/shims/eventemitter3.js") },
        // Match any nested copy of use-sync-external-store/shim/with-selector(.js)
        {
          find: /use-sync-external-store[\\/]shim[\\/]with-selector(\.js)?$/,
          replacement: path.resolve(__dirname, "./src/shims/use-sync-external-store-shim.js"),
        },
        // Also force base shim to our ESM re-export from React
        {
          find: /use-sync-external-store[\\/]shim([\\/]index\.js)?$/,
          replacement: path.resolve(__dirname, "./src/shims/use-sync-external-store-base-shim.js"),
        },
        ...
        { find: /^debug$/, replacement: path.resolve(__dirname, "./src/shims/debug-shim.js") },
        {
        ...
        { find: /^extend$/, replacement: path.resolve(__dirname, "./src/shims/extend-shim.js") },
        { find: /extend\/index\.js$/, replacement: path.resolve(__dirname, "./src/shims/extend-shim.js") },
        // Additional CommonJS compatibility fixes
        { find: /^xtend$/, replacement: path.resolve(__dirname, "./src/shims/extend-shim.js") },
      ],
  },
  optimizeDeps: {
    exclude: [
